...
Pada plot tersebut, terlihat bahwa data berpola trend. Metode pemulusan yang cocok adalah Double Moving Average (DMA) dan Double Exponential Smoothing (DES).

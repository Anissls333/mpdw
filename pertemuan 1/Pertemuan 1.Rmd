...
perbandingan
```
Kedua metode dapat dibandingkan dengan menggunakan ukuran akurasi yang sama. Berdasarkan nilai SSE, MSE, dan MAPE, metode DES lebih baik karena memiliki ukuran akurasi yang lebih kecil dibandingkan dengan metode DMA. Berdasarkan nilai MAPE nya kedua metode tersebut memberikan peramalan dengan akurasi yang sangat baik karena kurang dari 10%.
